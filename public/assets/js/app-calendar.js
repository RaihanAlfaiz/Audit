...
document.addEventListener("DOMContentLoaded", function () {
    ...
    }).on("core.form.valid", function () { r = !0 }).on("core.form.invalid", function () { r = !1 }),
    y.addEventListener("click", e => {
        ...
        r && (n = {
            ...
            display: "block",
            allDay: !!T.checked
        }, (t = n).id = parseInt(t.id), l[l.findIndex(e => e.id === t.id)] = t, i.refetchEvents(), $('#addEventModal').modal('hide'));
    }),
    S.addEventListener("click", e => {
        var t;
        t = parseInt(a.id), l = l.filter(function (e) { return e.id != t }), i.refetchEvents(), $('#addEventModal').modal('hide');
    }),
